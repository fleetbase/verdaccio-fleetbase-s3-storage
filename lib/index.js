...
class S3Database {
    ...
    constructor(config, options) {
        ...
        this.config.region = (0, getConfigValue_1.default)('AWS_REGION', this.config);
        this.config.accessKeyId = (0, getConfigValue_1.default)('AWS_ACCESS_KEY_ID', this.config);
        this.config.secretAccessKey = (0, getConfigValue_1.default)('AWS_SECRET_ACCESS_KEY', this.config);
        this.config.sessionToken = (0, getConfigValue_1.default)('AWS_SESSION_TOKEN', this.config);
